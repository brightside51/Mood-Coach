...
<html>
    ...
    <head>
        <meta charset = "utf-8">
        <title>Mood Coach | Support Page</title>
        <meta name = "viewport"
        ...
        <div class = "container">
            ...
            <div>
                <div id="sptext">
                    ...
                    <p class = "support"> There are many organizations that specialyze in dealing and helpin patients with different mental health problems. In this
